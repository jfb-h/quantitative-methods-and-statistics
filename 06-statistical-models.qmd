...
|---------------|---------------|---------------|---------------|
| **Normal** | Continuous | $\mathbb{R} \quad (-\infty, \infty)$ | $\mu$ (location) <br>  $\sigma$ (scale) 
| **Student-t** | Continuous | $\mathbb{R} \quad (-\infty, \infty)$ | $\nu$ (df) <br> $\mu$ (location) <br> $\sigma$ (scale) 
| **Exponential** | Continuous | $[0,\infty)$ | $\lambda$ (rate) 
| **Beta** | Continuous | $(0,1)$ | $\mu$ (mean) <br> $\phi$ (precision) 
| **Binomial** | Discrete | $\{0,\dots,n\}$ | $n$ (trials) <br> $\theta$ (success prob) 
| **Poisson** | Discrete | $\mathbb{N}_0 \quad \{0, 1, 2, ...\}$ | $\lambda$ (mean) 
| **Negative Binomial** | Discrete | $\mathbb{N}_0 \quad \{0, 1, 2, ...\}$ | $\mu$ (mean) <br> $\phi$ (scale) 
...
- Generate random values (i.e., _sampling_) from the distribution 
